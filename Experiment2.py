...
def main():
    SListCopy11, IListCopy11, UListCopy11, AListCopy11 = SIS(500, 0.8, 0, 0.5, 0.1, 0.2, 50, 20)
    SListCopy21, IListCopy21, UListCopy21, AListCopy21 = SIS(500, 0.8, 0.2, 0.5, 0.1, 0.2, 50, 20)
    SListCopy31, IListCopy31, UListCopy31, AListCopy31 = SIS(500, 0.8, 0.4, 0.5, 0.1, 0.2, 50, 20)
    SListCopy41, IListCopy41, UListCopy41, AListCopy41 = SIS(500, 0.8, 0.6, 0.5, 0.1, 0.2, 50, 20)
    ...
    SListCopy12, IListCopy12, UListCopy12, AListCopy12 = SIS(500, 0.4, 0, 0.5, 0.1, 0.2, 50, 20)
    SListCopy22, IListCopy22, UListCopy22, AListCopy22 = SIS(500, 0.4, 0.2, 0.5, 0.1, 0.2, 50, 20)
    SListCopy32, IListCopy32, UListCopy32, AListCopy32 = SIS(500, 0.4, 0.4, 0.5, 0.1, 0.2, 50, 20)
    SListCopy42, IListCopy42, UListCopy42, AListCopy42 = SIS(500, 0.4, 0.6, 0.5, 0.1, 0.2, 50, 20)
    ...
    SListCopy13, IListCopy13, UListCopy13, AListCopy13 = SIS(500, 0.2, 0, 0.5, 0.1, 0.2, 50, 20)
    SListCopy23, IListCopy23, UListCopy23, AListCopy23 = SIS(500, 0.2, 0.2, 0.5, 0.1, 0.2, 50, 20)
    SListCopy33, IListCopy33, UListCopy33, AListCopy33 = SIS(500, 0.2, 0.4, 0.5, 0.1, 0.2, 50, 20)
    SListCopy43, IListCopy43, UListCopy43, AListCopy43 = SIS(500, 0.2, 0.6, 0.5, 0.1, 0.2, 50, 20)
    ...
    SListCopy14, IListCopy14, UListCopy14, AListCopy14 = SIS(500, 0, 0, 0.5, 0.1, 0.2, 50, 20)
    SListCopy24, IListCopy24, UListCopy24, AListCopy24 = SIS(500, 0, 0.2, 0.5, 0.1, 0.2, 50, 20)
    SListCopy34, IListCopy34, UListCopy34, AListCopy34 = SIS(500, 0, 0.4, 0.5, 0.1, 0.2, 50, 20)
    SListCopy44, IListCopy44, UListCopy44, AListCopy44 = SIS(500, 0, 0.6, 0.5, 0.1, 0.2, 50, 20)
